...
def main():
    ...
    for nome, salario in zip(nomes.entradaDeDados(), salarios.entradaDeDados()):
        print(f"{nome}: {salario}")
        
    salarios_reajustados = list(map(lambda x: x * 1.1, salarios.entradaDeDados()))
    ...
    datas_modificadas = list(map(modificar_data, filter(lambda x: x.ano < 2019, datas.entradaDeDados())))
    print(datas_modificadas)
